...
from EEequipment.TestEquipment import DMM, PowerSupply, FunctionGenerator, Oscilloscope
...
ALL_BASES = (TestEquipment,)
DMM_BASES = (DMM,)
PS_BASES = (PowerSupply,)
FG_BASES = (FunctionGenerator,)
OSC_BASES = (Oscilloscope,)
